...
* Online-Überweisung: Onlineüberweisung eps, iDEAL | Wero, Przelewy24, Alipay, WeChat Pay, Trustly & Blik etc.
...
* [Credit cards](https://www.novalnet.com/payment-processing/credit-card/ "Credit cards") (3DSecure also available): Visa, Mastercard, American Express, JCB, UnionPay, Diners Club,  Discover etc.

* Debit cards: Maestro, Visa, Carte Bleue, CartaSi, Postepay, PostFinance, dankort etc.

* Online bank transfers: Online bank transfer, eps, iDEAL | Wero, Przelewy24, PostFinance Card, PostFinance E-Finance, Bancontact, Alipay, WeChat Pay, Trustly & Blik etc.
...
To process Novalnet payments through this WooCommerce Payment Plugin, a [Novalnet account](https://www.novalnet.de/kontakt "Novalnet account") is needed.
...
* Download the WooCommerce payment plugin - Novalnet from WordPress repository and Click "Install Now" to install the plugin. A popup window will ask you to confirm your wish to install the plugin 12.10.4.
...
= 12.10.4 =
  ...
  * [Enhanced] Improved webhook request validation for secure and reliable processing
...
= 12.10.2 =
  ...
  * [Fix] Credit card payment processing in multistep checkout with Germanized pro plugin
  * [Fix] Instalment Summary is displayed in the Order History section of the customer account
  * [Enhanced] iDEAL payment logo and title to iDEAL | Wero
  * [Enhanced] Credit/Debit Card logos displayed on the checkout page have been limited
  * [Enhanced] Improved the Instalment payment text on the product page for better clarity
...
4. Please click on the “Checkout” tab in order to configure your Novalnet payment interface properly. Inside the “Checkout” tab you will have the individual payment (eg. Direct Debit SEPA) configuration. The payment configuration is structured as follows:
    ...
    * **One-click shopping** One click shopping for One-click shopping supported for Credit/Debit Cards, Direct Debit SEPA, Direct Debit ACH, Direct Debit SEPA with payment guarantee & Instalment by Direct Debit SEPA. 
